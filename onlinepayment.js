...
function register() {
    ...
    const phonePattern = /^[0-9]{11}$/; // Assuming 10-digit phone number
...
function logOut() {
    // Clear user data (simulate removing session data)
    clearUserData();

    // Show the Thank You Form
    switchToForm("thank-you-form");
...
function clearUserData() {
    // Clear fields in the login form (simulate logging out)
    document.getElementById("login-student-number").value = "";
